...
class NewTestContact(unittest.TestCase):
    ...
    def test_new_test_contact(self):
        ...
        driver.find_element_by_name("firstname").send_keys("Sasha")
        driver.find_element_by_name("middlename").click()
        driver.find_element_by_name("middlename").clear()
        driver.find_element_by_name("middlename").send_keys("Alex")
        driver.find_element_by_name("nickname").click()
        driver.find_element_by_name("nickname").clear()
        driver.find_element_by_name("nickname").send_keys("Sa")
